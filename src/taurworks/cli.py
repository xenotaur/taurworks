import argparse
from taurworks.manager import create_project, activate_project, list_projects, refresh_project
...
def main():
    ...
    if args.command == "projects":
        ...
        create_project(args.project_name, python_version=args.python,
                       packages=args.packages, env_file=args.file)
    elif args.command == "refresh":
        refresh_project(args.project_name, python_version=args.python,
                        packages=args.packages, env_file=args.file)
