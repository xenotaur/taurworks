...
- Added tests for resolver reasons, parent-directory `working-dir show`, current-project `working-dir show`, same-name activation, unknown-name safety, and read-only non-mutation.
